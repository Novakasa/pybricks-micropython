...
static void test_color_hsv_cost(void *env) {
    ...
    color_a.s = 100;
    color_a.v = 100;
    tt_want_int_op(pbio_get_bicone_cost(&color_a, &color_a), ==, 0);
    ...
    color_b.s = 99;
    color_b.v = 0;
    tt_want_int_op(pbio_get_bicone_cost(&color_a, &color_b), ==, 0);
    ...
    dist = pbio_get_bicone_cost(&color_a, &color_b);
    ...
    tt_want_int_op(pbio_get_bicone_cost(&color_a, &color_b), >, dist);
